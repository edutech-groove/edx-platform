    ...
    var DetailsView = ValidatingView.extend({
      ...
      initialize: function(options) {
        ...
        this.licenseModel = new LicenseModel({
          asString: this.model.get('license')
        });
      ...
      render: function() {
        ...
        this.initializeTinyMCE('#' + this.fieldToSelectorMap.overview);
        ...
        this.initializeTinyMCE('#course-about-sidebar-html');
      ...
      addInstructorFields: function() {
        ...
        this.model.set('instructor_info', {
      ...
      initializeTinyMCE: function(elementId) {
        var _this = this;
        ...
        TinyMCE.init({
          ...
          init_instance_callback: function(editor) {
            editor.on('Change', function(e) {
              _this.showNotificationBar();
              _this.model.set('overview', editor.getContent());
            });
          },
          ...
          block_formats: interpolate("%(paragraph)s=p;%(heading3)s=h3;%(heading4)s=h4;%(heading5)s=h5;%(heading6)s=h6", {
      ...
      revertView: function() {
        ...
        this.model.fetch({
          success: function() {
            ...
            self.licenseModel.setFromString(self.model.get('license'), {
              silent: true
            });
